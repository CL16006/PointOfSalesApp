...
import fatima.app.project.pointofsalesapp.entities.Permiso;
...
public class PermisoFacadeREST extends AbstractFacade<Permiso> {
    ...
    @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@jakarta.ws.rs.PathParam("id") Integer id, Permiso entity) {
        super.edit(entity);
    }
    ...
    public Permiso find(@jakarta.ws.rs.PathParam("id") Integer id) {
    ...
    @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<Permiso> findRange(@jakarta.ws.rs.PathParam("from") Integer from, @jakarta.ws.rs.PathParam("to") Integer to) {
