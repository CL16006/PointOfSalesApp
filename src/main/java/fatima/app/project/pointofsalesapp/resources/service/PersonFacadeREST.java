...
import fatima.app.project.pointofsalesapp.entities.Person;
...
public class PersonFacadeREST extends AbstractFacade<Person> {
    ...
    @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@jakarta.ws.rs.PathParam("id") Integer id, Person entity) {
        super.edit(entity);
    }
    ...
    public Person find(@jakarta.ws.rs.PathParam("id") Integer id) {
    ...
    @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<Person> findRange(@jakarta.ws.rs.PathParam("from") Integer from, @jakarta.ws.rs.PathParam("to") Integer to) {
