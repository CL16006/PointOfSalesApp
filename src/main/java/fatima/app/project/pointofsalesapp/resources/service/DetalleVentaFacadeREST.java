...
import fatima.app.project.pointofsalesapp.entities.DetalleVenta;
...
@jakarta.ws.rs.Path("detalleventa")
public class DetalleVentaFacadeREST extends AbstractFacade<DetalleVenta> {
    ...
    @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@jakarta.ws.rs.PathParam("id") Integer id, DetalleVenta entity) {
        super.edit(entity);
    }
    ...
    public DetalleVenta find(@jakarta.ws.rs.PathParam("id") Integer id) {
    ...
    @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<DetalleVenta> findRange(@jakarta.ws.rs.PathParam("from") Integer from, @jakarta.ws.rs.PathParam("to") Integer to) {
