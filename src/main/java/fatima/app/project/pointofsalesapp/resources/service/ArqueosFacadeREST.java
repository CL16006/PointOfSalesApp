...
import fatima.app.project.pointofsalesapp.entities.Arqueos;
...
@jakarta.ws.rs.Path("arqueos")
public class ArqueosFacadeREST extends AbstractFacade<Arqueos> {

    @PersistenceContext(unitName = "fatima.app.project_PointOfSalesApp_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    public ArqueosFacadeREST() {
        super(Arqueos.class);
    }
    ...
    public void create(Arqueos entity) {
        super.create(entity);
    }
    ...
    @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@jakarta.ws.rs.PathParam("id") Integer id, Arqueos entity) {
        super.edit(entity);
    }
    ...
    public Arqueos find(@jakarta.ws.rs.PathParam("id") Integer id) {
    ...
    @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<Arqueos> findRange(@jakarta.ws.rs.PathParam("from") Integer from, @jakarta.ws.rs.PathParam("to") Integer to) {
