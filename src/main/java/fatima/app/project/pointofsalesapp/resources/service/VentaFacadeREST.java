...
import fatima.app.project.pointofsalesapp.entities.Venta;
...
public class VentaFacadeREST extends AbstractFacade<Venta> {
    ...
    @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@jakarta.ws.rs.PathParam("id") Integer id, Venta entity) {
        super.edit(entity);
    }
    ...
    public Venta find(@jakarta.ws.rs.PathParam("id") Integer id) {
    ...
    @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<Venta> findRange(@jakarta.ws.rs.PathParam("from") Integer from, @jakarta.ws.rs.PathParam("to") Integer to) {
