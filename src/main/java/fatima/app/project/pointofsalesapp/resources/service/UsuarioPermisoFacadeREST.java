...
import fatima.app.project.pointofsalesapp.entities.UsuarioPermiso;
...
@jakarta.ws.rs.Path("usuariopermiso")
public class UsuarioPermisoFacadeREST extends AbstractFacade<UsuarioPermiso> {

    @PersistenceContext(unitName = "fatima.app.project_PointOfSalesApp_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    public UsuarioPermisoFacadeREST() {
    ...
    public void create(UsuarioPermiso entity) {
        super.create(entity);
    }
    ...
    @jakarta.ws.rs.Consumes({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@jakarta.ws.rs.PathParam("id") Integer id, UsuarioPermiso entity) {
        super.edit(entity);
    }
    ...
    public UsuarioPermiso find(@jakarta.ws.rs.PathParam("id") Integer id) {
    ...
    @jakarta.ws.rs.Produces({jakarta.ws.rs.core.MediaType.APPLICATION_XML, jakarta.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<UsuarioPermiso> findRange(@jakarta.ws.rs.PathParam("from") Integer from, @jakarta.ws.rs.PathParam("to") Integer to) {
