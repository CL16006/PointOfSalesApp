 ...
 */
@Entity
@Table(name = "detalle_ingreso", catalog = "ashor", schema = "")
@NamedQueries({
...
public class DetalleIngreso implements Serializable {
    ...
    @Column(name = "iddetalle_ingreso", nullable = false)
    ...
    @Basic(optional = false)
    @Column(name = "precio_compra", nullable = false, precision = 11, scale = 2)
    ...
    @JoinColumn(name = "idingreso", referencedColumnName = "idingreso", nullable = false)
    @ManyToOne(optional = false)
    ...
    public String toString() {
        return "fatima.app.project.pointofsalesapp.entities.DetalleIngreso[ iddetalleIngreso=" + iddetalleIngreso + " ]";
    }
